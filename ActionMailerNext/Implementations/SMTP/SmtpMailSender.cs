...
namespace ActionMailerNext.Implementations.SMTP
{
    ...
    public class SmtpMailSender : IMailSender, IDisposable
    {
        ...
        protected MailMessage GenerateProspectiveMailMessage(MailAttributes mail)
        {
            ...
            message.SubjectEncoding = mail.SubjectEncoding ?? Encoding.GetEncoding("ISO-8859-1"); //https://connect.microsoft.com/VisualStudio/feedback/details/785710/mailmessage-subject-incorrectly-encoded-in-utf-8-base64
